...
<template>
  <header
    class="bg-gradient-to-r from-primary-600 to-primary-700 text-white shadow-lg sticky top-0 z-50"
  >
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        >
          <div
            class="w-10 h-10 bg-white bg-opacity-20 rounded-lg flex items-center justify-center backdrop-blur-sm"
          >
            <svg
          ...
          <div>
            <div class="text-xl font-bold">VolunteerHub</div>
        ...
        <nav class="hidden md:flex items-center space-x-1">
          <RouterLink
            to="/home"
            class="px-4 py-2 rounded-lg text-sm font-medium hover:bg-white hover:bg-opacity-20 transition-colors"
